...
<body id="page-top">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 mx-auto">
                    <p class="text-info mb-5"><strong style="color: white; font-size: 25px">Somos una empresa
                            ...
                            personal e higiene, con el propósito de brindar soluciones productivas y efectivas en el
                            campo laboral</strong></p>
                    <!--<a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">Find Out More</a>-->
                </div>
                <div class="col-lg-10 mx-auto">
                    <a class="btn btn-primary js-scroll-trigger consu" href="#consulta">Consultar</a>
                    <a class="btn btn-success verp js-scroll-trigger        " href="#services">Ver Productos</a>
                </div>
            </div>
            <div class="secnos">
                <img src="/img/servicios/distribucion.png"style="width: 40px; border-radius: 100px;" /><strong class="sti">Distribucion de equipos</strong>
                <img src="/img/servicios/capacitacion.png"style="width: 40px; border-radius: 100px;" /><strong class="sti">Realización de capacitaciones</strong>
                <img src="/img/servicios/noise.png"style="width: 40px; border-radius: 100px;" /><strong class="sti">Medición de ruido</strong>
                <img src="/img/servicios/laws.png"style="width: 40px; border-radius: 100px;" /><strong class="sti">Normas legales</strong>
            </div>
    ...
    <section class="bg-primary prop" id="about">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        <a href="/productos/tipos/proteccion-auditiva"><img src="/productosimg/audio.JPG" class="imgtp"style="width: 50% "></a>
                        <h3 class="mb-3">Protección auditiva</h3>
                        <!--<p class="text-muted mb-0">Our templates are updated regularly so they don't break.</p>-->
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                       <a href="/productos/tipos/chaleco"><img src="/productosimg/chalecos.JPG" class="imgtp" style="width: 50%"></a>
                        <h3 class="mb-3">Chalecos</h3>
                        <!--<p class="text-muted mb-0">You can use this theme as is, or you can make changes!</p>-->
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        <a href="/productos/tipos/casco"><img src="/productosimg/calzado.JPG" style="width: 50%" class="imgtp"></a>
                        <h3 class="mb-3">Cascos</h3>
                        <!--<p class="text-muted mb-0">We update dependencies to keep things fresh.</p>-->
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        <a href="/productos/tipos/guantes"><img src="/productosimg/guantes.JPG" style="width: 50%" class="imgtp"></a>
                        <h3 class="mb-3">Guantes</h3>
                        <!-- <p class="text-muted mb-0">You have to make your websites with love these days!</p>-->
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        <a href="/productos/tipos/calzado"><img src="/productosimg/calzado.JPG" style="width: 50%" class="imgtp"></a>
                        <h3 class="mb-3">Calzado</h3>
                        <!-- <p class="text-muted mb-0">You have to make your websites with love these days!</p>-->
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        <a href="/productos/tipos/proteccion-visual"><img src="/productosimg/visual.JPG" style="width: 50%" class="imgtp"></a>
                        <h3 class="mb-3">Protección Visual</h3>
                        <!-- <p class="text-muted mb-0">You have to make your websites with love these days!</p>-->
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        <a href="/productos/tipos/proteccion-frio"><img src="/productosimg/contrafrio.JPG" style="width: 50%" class="imgtp"></a>
                        <h3 class="mb-3">Protección contra el frío</h3>
                        <!-- <p class="text-muted mb-0">You have to make your websites with love these days!</p>-->
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                        <a href="/productos/tipos/traje-proteccion"><img src="/productosimg/trajeproteccion.JPG" style="width: 50%" class="imgtp"></a>
                        <h3 class="mb-3">Trajes de protección</h3>
                        <!-- <p class="text-muted mb-0">You have to make your websites with love these days!</p>-->
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 mx-auto"> 
                    ...
                    <div class="form-control">
                        <form id="emailer_form" action="enviar-correo" method="post">
                            ...
                            <button id="submit_consulta" type="submit" class="btn btn-info"><i class="fa fa-send"></i>
                                Enviar</button>
                        </form>
                    </div>
                </div>
